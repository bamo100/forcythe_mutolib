...
const Beaupreneur = () => {
    const title = 'Beaupreneur'
    const paragraph = 'I’m beyond impressed with the dedication Forcythe showed. They didn’t just deliver—they educated us, involving us in the creative process. The result? A website that truly feels like ours and speaks directly to our customers’ hearts.'
    const citation = 'Christiana, Founder'
    return (
    <div className='p-[1.7rem] bg-[#0c2645] rounded-[2rem] w-full sm:w-[55%] h-full text-white flex flex-col sm:flex-row gap-2'>
        ...
        <div className='sm:w-[42%] w-full h-[20rem] sm:h-auto relative object-top mt-3 sm:mt-0'>
            <Image src='https://forcythe.com/images/christina.svg' alt='beaupreneur_ceo' width={20} height={20} className='w-full h-full rounded-xl object-cover' /> 
        </div>
    </div>
  )
}
